...
const ContactReducer = (state = { contactdata: [] }, actions) => {
    ...
    switch (actions.type) {
        ...
        case ON_SUCCESS:
            return { ...state, contactData: actions.payload, loading: false, message: "your data have been saved successfully!" }
        case ON_FAIL:
...
export { ContactReducer, fetchAllContactReducer, fetchSingleContactsReducers, deleteContactReducers, updateContactReducers };