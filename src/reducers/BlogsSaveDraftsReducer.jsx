...
const BlogsFindByIdDraftsReducers = (state = { blogsSingleData: [] }, actions) => {
    switch (actions.type) {
...
const BlogsUpdateDraftsReducers = (state = { blogsUpdatedData: [] }, actions) => {
    switch (actions.type) {
...
const BlogDeleteDraftsReducers = (state = { blogsDeletedData: [] }, actions) => {
    switch (actions.type) {
...
export { BlogsSaveDraftsReducers, BlogsFindAllDraftsReducers, BlogsFindByIdDraftsReducers, BlogsUpdateDraftsReducers, BlogDeleteDraftsReducers };