...
import { Card, Box, Paper, CardContent, CardActions, Button, Typography, makeStyles } from "@material-ui/core";
...
const Login = () => {
    ...
    const { loading, loginData } = useSelector((state) =>
        state.login);
    ...
    return (<div className={cn(classes.root)}>
        <Paper className={cn(classes.SignInWrapper)} >
            <Card sx={{ minWidth: 275 }} elevation={0}>
                ...
                <CardActions>
                    <Button size="small" onClick={handleLogin}>Sign In</Button>
                </CardActions>
