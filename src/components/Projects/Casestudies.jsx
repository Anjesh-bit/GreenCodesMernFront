...
import { Grid, Box, Typography, Card, CardContent, Paper, CardMedia, useMediaQuery, useTheme } from '@material-ui/core';
        ...
        <AnimatePresence>
            ...
            <motion.div initial={{ x: "-100%" }}
                ...
                <Grid container className={cn(classes.root)}>
                    ...
                    <Grid items md={12} sm={12} xs={12} lg={6} style={matches ? { marginLeft: "3em" } : {}}>
