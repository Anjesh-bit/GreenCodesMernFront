...
import { Grid, MobileStepper, makeStyles, Button, Typography, useMediaQuery, useTheme } from "@material-ui/core";
...
const title = {
    color: "#878a8f", letterSpacing: "0.1em", fontSize: "4em", fontWeight: 800, padding: 0, margin: 0
}
const Project = () => {
    ...
    return (
        <motion.div style={!matchXs ? {
            paddingLeft: "3em", paddingRight: "3em", paddingBottom: "1em", background: "#F5F5F5", position: "relative"
        } : { paddingLeft: "1em", paddingRight: "1em" }}
            initial={{ left: "-100%" }} whileInView={{ left: 0 }} transition={{ ease: "easeInOut", delay: 1, duration: 1, type: "spring" }}
        >
            <Typography variant="h6" className={cn(classes.h1)}>SELECTED PROJECTS</Typography>
            <Typography variant="h3" style={{ fontWeight: 600, color: "#878a8f", background: "#042825", width: "fit-content", letterSpacing: "0.1em" }}>Latest Projects </Typography>
            {
            ...
            <Grid container className={cn(classes.root)}>
                ...
                <Grid component="motion.div" items className={cn(classes.greenimagesdiv)} xs={12} >
...

                    {
                        GreenImages?.map((data, index) =>
                            ...
                            <div key={Math.random()} className={classes.imageContainer} onMouseEnter={() => { setShow(index); setAnim(false) }} onMouseLeave={() => { setShow(-1); setAnim(false) }}>

                                <motion.img key={Math.random()} src={data.all} className={cn(classes.greenImages)}
                                ...
                                {show === index ? <motion.div key={index} className={classes.onHoverimages}
                                    initial={{ height: 0 }}
                                    transition={{
                                        duration: 0.8, ease: "easeInOut", type: "spring"
                                    }}
                                    animate={{ height: "100%" }
                                ...
                                >
                                    ...
                                    <motion.div style={{ textAlign: "start", paddingLeft: "0.5em" }}
                                        initial={{ y: "25%" }}
                                        transition={{
                                    ...
                                    >
                                        ...
                                        <Link to="/projects" state={{
                                            ...
                                            style={{ color: "#878a8f", fontSize: "1em", textDecoration: "none" }}>
