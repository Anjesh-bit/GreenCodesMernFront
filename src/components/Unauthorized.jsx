...
import { Grid, makeStyles, Box, Card, Paper, CardContent, Typography, CardActions, Button } from "@material-ui/core";
                    ...
                    <Paper elevation={1}>
                        <Card className={cs(classes.TopCardContainer)} elevation={0}>
                            <CardContent>
                                ...
                                <Typography variant="h5" component="h3" className={cs(classes.topCardDenied)}>
                                ...
                                <Typography className={cs(classes.topCardPermission)} gutterBottom>
                                    <i>
                                        {CardContentText.permission}
                                    </i>
