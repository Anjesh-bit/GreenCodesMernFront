        ...
        <div className="maintopWrapper">
            ...
            <Grid container>
                <Grid item md={6} xs={12} sm={12}>
                    ...
                    <StyledButton style={!matchessm ? { color: "#ddd" } : { color: "#ddd", marginBottom: "2em" }} className="GreenConnected">Stay connected<ArrowForwardIcon /></StyledButton>
                </Grid>
                <Grid item md={6} xs={12} sm={12}>
...

                            {
                                TopbarImages.map((images, index) =>
                                    <div className="imagesTopbarWrapper">
                                        ...
                                        <img key={Math.random} src={images} className="imagesTopbar" />
                                    </div>
            ...
            <div className="shapesLeft"
                style={!matchessm ? { position: "absolute", right: `-${setOffsetY * 0.4}px`, transition: "all 0.8s linear" } : { display: "none" }}
            ...
            {!matches && <div className="shapesText">
                Innovation
            </div>}
