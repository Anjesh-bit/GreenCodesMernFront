...
const Contact = () => {
  ...
  const validate = () => {
    ...
    if (values.client_email) {
      error.error_email = regex.test(values.client_email)
        ? ""
        : "Please enter the valid email format.";
    }

    error.error_number = values.client_number
      ? ""
      : contErrorMessage.error_number;

    error.error_message = values.client_message
      ? ""
      : contErrorMessage.error_message;
            ...
            <Grid container md={6} sm={6} xs={12} className={cn(classes.root)}>
              ...
              >
                <CardContent>
                  ...
                  <Typography
                    variant="h3"
                    style={{ fontWeight: 800, color: "#878a8f" }}
                    component="div"
                    gutterBottom
                  >
                    {contact01}
                ...
                <CardContent>
                  ...
                  <Grid items xs={12}>
                    <StyledButton onClick={handleSubmit}>
                      ...
                      />
                      {contactState.loading && <Loader />}Send message
                    </StyledButton>
                  </Grid>
                </CardContent>
              </Card>
