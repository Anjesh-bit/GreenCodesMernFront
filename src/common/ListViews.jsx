...
export default function ListViews() {
  ...
  return (
    <div className={classes.root}>
      <List
        component="nav"
        aria-label="home projects about us"
        style={{ width: "100%" }}
      >
        <h4
          style={{ color: "#878a8f", textAlign: "left", paddingLeft: "20px" }}
        >
          Menu
        </h4>
        <ListItem button>
          <Link to="/" className={cn(classes.link)}>
            <ListItemText primary="Home" disableTypography style={ListItems} />
          </Link>
        </ListItem>
        <ListItem button>
