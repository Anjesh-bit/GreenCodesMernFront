...
import { alpha, makeStyles, AppBar, Toolbar, InputBase, MenuItem, Menu } from '@material-ui/core';
...
import { IconButtonActions, MobileButtonActions } from '../actions/IconButtonActions';
...
const AppBars = () => {
    ...
    const renderMenu = (
        ...
        >
            <MenuItem onClick={handleProfileOpen} className={cn(classes.menuSpace)}><PersonIcon />Profile</MenuItem>
            <MenuItem onClick={handleMenuLogout}><ExitToAppIcon /> Logout</MenuItem>
        </Menu>
    );
    ...
    return (
        <div className={classes.grow}>
            ...
            {renderMobileMenu}
            {renderMenu}
            <GreenDrawer toggleDrawer={toggleDrawer} keyValue='top' anchor='top' open={top} />
        </div>
    );
}
